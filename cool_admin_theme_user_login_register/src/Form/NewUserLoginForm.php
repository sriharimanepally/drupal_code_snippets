...
/**
 * @file
 * Contains \Drupal\cool_admin_theme_user_login_register\Form\NewUserLoginForm.
 */

namespace Drupal\cool_admin_theme_user_login_register\Form;
...
class NewUserLoginForm extends UserLoginForm {
    ...
    public function buildForm(array $form,FormStateInterface $form_state)
    {
        ...
        $form['pass'] = [
          ...
          '#required' => TRUE,
          '#suffix' => '<i class="ti-lock"></i>',
        ];

        $form['#attached']['library'][] = 'cool_admin_theme_user_login_register/cool_admin_theme_user_login_register.custom_user_login';


        // $value = new FormattableMarkup('<i class="ti-arrow-right"></i>@text', [
        //   '@text' => 'Submit',
        // ]);

        $form['actions'] = ['#type' => 'actions'];
        $form['actions']['submit'] = ['#type' => 'submit', '#value' => $this->t('Submit')];
        // $form['actions']['submit'] = ['#type' => 'submit', '#value' => $value];
