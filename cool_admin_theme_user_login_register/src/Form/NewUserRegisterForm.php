...
/**
 * @file
 * Contains \Drupal\cool_admin_theme_user_login_register\Form\NewUserRegisterForm.
 */
...
class NewUserRegisterForm extends RegisterForm {
  ...
  // }
    ...
    $form['#validate'][] = 'Drupal\cool_admin_theme_user_login_register\Controller\CustomUserLoginRegister::example_form_validate';
