...
/**
 * @file
 * Contains \Drupal\form_overwrite\Form\NewUserRegisterForm.
 */
...
class NewUserRegisterForm extends RegisterForm {
  ...
  // }
    ...
    $form['#attached']['library'][] = 'form_overwrite/form_overwrite.custom_user_register';

    return $form;


//   $form['test'] = [
//     '#markup' => '<p>Test extended form abcd</p>',
// ];
// return $form;
  }
