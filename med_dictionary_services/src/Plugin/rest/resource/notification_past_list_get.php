 ...
 *
 * @RestResource(
 *   id = "notification_past_list_get",
 *   label = @Translation("notification_past_list_get"),
 *   uri_paths = {
 *     "canonical" = "/notification_past_list_get/{device_uuid}"
 *   }
 * )
 */
class notification_past_list_get extends ResourceBase {
    /**
