 ...
 * @RestResource(
 *   id = "recently_viewed",
 *   label = @Translation(" recently viewed."),
 *   uri_paths = {
 *     "canonical" = "/recently_viewed/{id}"
 *   }
 * )
 */
class recently_viewed extends ResourceBase {
    /**
...
limit 5";
  ...
  $data['constituents']= json_decode(get_constituents($record['medicine_name']),true);
...
function get_constituents($medicine_name)
{
