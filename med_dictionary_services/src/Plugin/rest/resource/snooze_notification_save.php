 ...
 *
 * @RestResource(
 *   id = "snooze_notification_save",
 *   label = @Translation("Save snooze notification flag."),
 *   uri_paths = {
 *     "canonical" = "/snooze_notification_save/{device_uuid}"
 *   }
 * )
 */
class snooze_notification_save extends ResourceBase {
    /**
    ...
    public function get($uuid= null) 
    {
          ...
          $id = '';
            $type = 'data_calander';
            $fields = array('id' => urlencode($uuid), 'status' => 3);
