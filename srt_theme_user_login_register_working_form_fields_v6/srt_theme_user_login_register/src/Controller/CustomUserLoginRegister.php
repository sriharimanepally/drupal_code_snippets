...
namespace Drupal\srt_theme_user_login_register\Controller;
...
class CustomUserLoginRegister {
    ...
    public function sendVerificationCode($email_value){
...
//     $data=$query;
 ...
 sendmail($subject,$body,$to);
    ...
    public function verifyCode($email_value,$verification_code){
