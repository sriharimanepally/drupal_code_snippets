...
/**
 * @file
 * Contains \Drupal\sufee_theme_user_login_register\Form\NewUserLoginForm.
 */
...
class NewUserLoginForm extends UserLoginForm {
    ...
    $form['#attached']['library'][] = 'sufee_theme_user_login_register/sufee_theme_user_login_register.custom_user_login';

		$form['actions'] = ['#type' => 'actions'];
		$form['actions']['submit'] = ['#type' => 'submit', '#attributes' => ['class'=>['btn btn-success','btn-flat','m-b-30','m-t-30']] ,'#value' => $this->t('SIGN IN')];
